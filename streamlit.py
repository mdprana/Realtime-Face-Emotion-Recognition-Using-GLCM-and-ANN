...
def main():
    with st.sidebar:
        ...
        mode = st.selectbox("Select Mode", ["Camera", "Upload Image"])
    ...
    st.title("Realtime Emotion Recognition App")
    ...
    with col1:
        if mode == "Camera":
            ...
            img_file_buffer = st.camera_input("Capture your expression")
            if img_file_buffer:
    ...
    with col2:
        ...
        2. For camera: Click capture
        3. For upload: Choose image file
        4. View detected emotions
        """)
